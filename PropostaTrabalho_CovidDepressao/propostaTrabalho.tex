...
% O subestágio de análise é dividido em três subprocessos e é representado na Figura \ref{fig:parsing_stage}. 
...
% O gráfico de polaridade pode ajudar a identificar se as palavras e termos mais usados ​​por um usuário tendem a ser positivos ou negativos. 
...
% A fase experimental descreve os resultados da análise de redes sociais (SNA). Selecionamos alguns grupos de métricas para entender o que são entidades de rede com os maiores valores de métricas.
